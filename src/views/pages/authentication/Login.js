...
// import LoginVerificationModel from "./LoginVerificationModel";
    ...
    if (Object.values(data).every((field) => field.length > 0)) {
      useJwt
        ...
        .then((res) => {
          ...
          let access = [{ action: "manage", subject: "all" }];
          const data = {
            ...userDetails,
          ...
          navigate(getHomeRouteForLoggedInUser(res.data.user.role));
          /*  const data = {
            ...res.data.userData,
    ...
    <div className="auth-wrapper auth-cover">
      <Row className="auth-inner m-0">
        <Link className="brand-logo" to="/" onClick={(e) => e.preventDefault()}>
          ...
          <h2 className="brand-text text-primary ms-1">Puffs N Roll</h2>
        </Link>
      ...
      {/* <LoginVerificationModel isOpen=
      {openOTPModel} token={token} /> */}
    </div>
  );
};
